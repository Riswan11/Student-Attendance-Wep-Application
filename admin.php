        ...
        <form method="post" action="admin_server.php">
            <div class="card-content">
                <div class="input-field ">
                    <input id="student_id" type="text" class="validate" name="username">
                    <label for="student_id">Username:</label>
                </div>
                <div class="input-field ">
                    <input id="course_no" type="text" class="validate" name="password">
                    <label for="course_no">Password:</label>
